                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn btn-primary text-center" onclick="addbook(${product.ID}, 1, 'book')">Add
                                to Cart</div>
                        </div>
                    </div>
                </div>
